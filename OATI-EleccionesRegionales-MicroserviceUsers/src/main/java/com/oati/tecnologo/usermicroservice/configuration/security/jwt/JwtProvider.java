package com.oati.tecnologo.usermicroservice.configuration.security.jwt;
...
public class JwtProvider {
    ...
    public String getIdUserFromToken(String token)  {
        return Jwts.parser().setSigningKey(secret.getBytes()).parseClaimsJws(token).getBody().get(Constants.IDUSER, String.class);
    }
    ...
    public String refreshToken(String token) throws ParseException {
        ...
        String idUser = claims.getStringClaim(Constants.IDUSER);


        return Jwts.builder()
                .setSubject(nombreUsuario)
                .claim(Constants.IDUSER, idUser)
