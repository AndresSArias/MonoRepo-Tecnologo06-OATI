...
public class Constants {
    ...
    public static final Long  CANDIDATE_ROLE_ID = 2L;
    public static final Long  CITIZEN_ROLE_ID= 3L;

    public static final String RESPONSE_MESSAGE_KEY = "message";
    public static final String PLATE_UPDATED_MESSAGE = "The points of user is succesfull update";
    public static final String USER_CANDIDATE_CREATED_MESSAGE = "UserCandidate created successfully";
    ...
    public static final String SWAGGER_TITLE_MESSAGE = "User API OATI Elecciones Regionales";
