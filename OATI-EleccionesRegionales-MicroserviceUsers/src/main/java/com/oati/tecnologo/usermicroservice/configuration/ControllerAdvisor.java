...
import com.oati.tecnologo.usermicroservice.domain.exceptions.AgeNotAllowedForCreationException;
import com.oati.tecnologo.usermicroservice.domain.exceptions.DNIIsSoBigException;
import com.oati.tecnologo.usermicroservice.domain.exceptions.NitRestaurantException;
...
public class ControllerAdvisor {
    ...
    public ResponseEntity<Map<String,String>> handleNoFormatDataException (NoFormatDataException noFormatDataException){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(Collections.singletonMap(Constants.RESPONSE_ERROR_MESSAGE_KEY, Constants.NO_FORMAT_DATE_MESSAGE));
    }
    ...
    public ResponseEntity<Map<String, String>> handlePersonAlreadyExistsException(
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(Collections.singletonMap(Constants.RESPONSE_ERROR_MESSAGE_KEY, Constants.USER_ALREADY_EXISTS_MESSAGE));
    }
    ...
    public ResponseEntity<Map<String, String>> handleMailAlreadyExistsException(
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(Collections.singletonMap(Constants.RESPONSE_ERROR_MESSAGE_KEY, Constants.MAIL_ALREADY_EXISTS_MESSAGE));
    }
    ...
    public ResponseEntity<Map<String, String>> handleClientNotFoundException(
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(Collections.singletonMap(Constants.RESPONSE_ERROR_MESSAGE_KEY, Constants.CLIENT_NOT_FOUND_MESSAGE));
    }
    ...
    public ResponseEntity<Map<String, String>> handlenAgeNotAllowedForCreationException(
        ...
        return ResponseEntity.status(HttpStatus.NOT_ACCEPTABLE)
                .body(Collections.singletonMap(Constants.RESPONSE_ERROR_MESSAGE_KEY, Constants.AGE_NOT_ALLOWED_MESSAGE));
    }
    ...
    public ResponseEntity<Map<String, String>> handlenDNIIsSoBigException(
        ...
        return ResponseEntity.status(HttpStatus.LENGTH_REQUIRED)
                .body(Collections.singletonMap(Constants.RESPONSE_ERROR_MESSAGE_KEY, Constants.DNI_SIZE_BIG_MESSAGE));
    }
    ...
    public ResponseEntity<Map<String, String>> handlenPhoneLenghtException(
        ...
        return ResponseEntity.status(HttpStatus.LENGTH_REQUIRED)
                .body(Collections.singletonMap(Constants.RESPONSE_ERROR_MESSAGE_KEY, Constants.PHONE_LENGHT_MESSAGE));
    }
    ...
    public ResponseEntity<Map<String, String>> handlenEmployeeHasWorkException(
        ...
        return ResponseEntity.status(HttpStatus.NOT_ACCEPTABLE)
                .body(Collections.singletonMap(Constants.RESPONSE_ERROR_MESSAGE_KEY, Constants.EMPLOYEE_HAS_WORK_MESSAGE));
    }
    ...
    public ResponseEntity<Map<String, String>> handlenNitRestaurantException(
        ...
        return ResponseEntity.status(HttpStatus.NOT_ACCEPTABLE)
                .body(Collections.singletonMap(Constants.RESPONSE_ERROR_MESSAGE_KEY, Constants.PROBLEM_NIT_RESTAURANT_MESSAGE));
    }
    ...
    public ResponseEntity<Map<String, String>> handleClientCannotUpdateRaitingException(
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(Collections.singletonMap(Constants.RESPONSE_ERROR_MESSAGE_KEY, Constants.CLIENT_CANNOT_UPDATE_RAITING_MESSAGE));
    }
